...
BLOCK_PERIOD = 150 # s
SYMBOL = ''
CONF_FILE_FUNC = lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Creditcoin') if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Creditcoin/') if platform.system() == 'Darwin' else os.path.expanduser('~/.creditcoin'), 'creditcoin.conf')
